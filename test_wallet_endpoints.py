#!/usr/bin/env python
"""
Test individual wallet endpoints using Django test client
"""
import os
import sys
...
def test_wallet_endpoints():
    """Test wallet endpoints using Django test client"""
    print("🔧 Testing wallet endpoints with Django test client...")
    ...
    response = client.post('/api/individual/wallet/wallet/deposit/', {'amount': 100, 'description': 'Test deposit'}, **headers)
