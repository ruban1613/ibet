#!/usr/bin/env python
"""
Comprehensive test script for Daily Wage Module enhancements.
...
def test_comprehensive_dailywage_wallet():
    """Comprehensive test for daily wage wallet functionality"""
    print("🔧 Running comprehensive daily wage wallet tests...")
    ...
    # Test 5: Add non-essential expense
    print("\n--- Test 5: Add Non-Essential Expense ---")
    ...
    print(f"Non-essential expense response: {response.status_code}")
    if response.status_code == 200:
        print("✅ Non-essential expense added successfully")
    else:
        print(f"❌ Error adding non-essential expense: {response.content.decode()}")
    ...
    # Test 8: Test alert functionality - withdraw large amount to trigger alert
    print("\n--- Test 8: Test Alert Functionality ---")
    response = client.post('/api/dailywage/wallet/withdraw/', {'amount': 600, 'description': 'Large expense', 'is_essential_expense': False}, **headers)
    print(f"Large withdrawal response: {response.status_code}")
    if response.status_code == 200:
        print("✅ Large withdrawal successful")
    else:
        print(f"❌ Error with large withdrawal: {response.content.decode()}")
...
if __name__ == '__main__':
    test_comprehensive_dailywage_wallet()
