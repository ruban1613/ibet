    ...
    def transfer_to_emergency(self, request):
        ...
        try:
            ...
            try:
                ...
                return Response({'error': _('Invalid amount format')}, status=status.HTTP_400_BAD_REQUEST)
            description = request.data.get('description', _('Emergency Fund Transfer'))
    ...
    def transfer_to_goals(self, request):
        ...
        try:
            ...
            try:
                ...
                return Response({'error': _('Invalid amount format')}, status=status.HTTP_400_BAD_REQUEST)
            goal_name = request.data.get('goal_name', _('Joint Goal'))
...
class GenerateCoupleWalletOTPView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({
            'message': _('OTP generated successfully for couple wallet operation'),
