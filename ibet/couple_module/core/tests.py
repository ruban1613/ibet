...
class OTPViewsTests(APITestCase):
    ...
    #     url = reverse('otp-generate')  # Assuming this URL exists
    ...
    #     url = reverse('wallet-access')  # Assuming this URL exists
...
class SecurityIntegrationTests(APITestCase):
    ...
    #     endpoints = [
    #         reverse('user-list'),  # Assuming these URLs exist
    #         reverse('wallet-detail'),
    ...
    #         response = self.client.post(reverse('otp-generate'), {
    #             'otp_code': '123456',
    #             'password': 'secret',
    #             'normal_field': 'value'
    #         })
