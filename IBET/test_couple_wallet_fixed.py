#!/usr/bin/env python
"""
Fixed test script for Couple Module wallet functionality
...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'core.settings_testing')
import django
django.setup()
...
def main():
    """Main test function"""
    print("🚀 Starting Couple Wallet Testing (Fixed Version)")
    print("=" * 60)
