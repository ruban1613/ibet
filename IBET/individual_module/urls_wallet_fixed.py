...
urlpatterns = [
    ...
    path('wallet/balance/', IndividualWalletViewSet.as_view({'get': 'balance'}), name='individual-wallet-balance'),
    path('wallet/deposit/', IndividualWalletViewSet.as_view({'post': 'deposit'}), name='individual-wallet-deposit'),
    path('wallet/withdraw/', IndividualWalletViewSet.as_view({'post': 'withdraw'}), name='individual-wallet-withdraw'),
    path('wallet/transfer-to-goal/', IndividualWalletViewSet.as_view({'post': 'transfer_to_goal'}), name='individual-wallet-transfer-goal'),
]
